...
// TODO: Backend Integration - This data should be fetched from Firestore/API for the specific productId
const mockProductsData: Product[] = [
  { id: 'prod1', name: 'Armazón Clásico Negro Elegante', price: 75000, stock: 25, category: 'Armazones Oftálmicos', sku: 'ACN-001', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'eyeglasses frame', lowStockThreshold: 10, costPrice: 30000, supplier: "OptiSupply Co.", description: "Un diseño atemporal y elegante, perfecto para cualquier ocasión. Fabricado con materiales de alta calidad para mayor durabilidad y confort.", branchId: 'branch1', branchName: 'Sucursal Central', ivaRate: 0.13 },
  { id: 'prod2', name: 'Lentes de Sol Aviador Protección UV400', price: 120000, stock: 8, category: 'Lentes de Sol', sku: 'LSA-002', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'sunglasses aviator', lowStockThreshold: 5, costPrice: 55000, supplier: "SunShades Inc.", description: "Estilo clásico de aviador con protección UV400 completa. Ligeros y resistentes, ideales para el uso diario.", branchId: 'branch1', branchName: 'Sucursal Central', tag: 'Amarilla', ivaRate: 0.13 },
  { id: 'prod3', name: 'Lentes de Contacto Mensuales (Caja 6)', price: 45000, stock: 50, category: 'Lentes de Contacto', sku: 'LCM-003', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'contact lenses', lowStockThreshold: 20, costPrice: 18000, supplier: "VisionCare Ltd.", description: "Caja con 6 lentes de contacto mensuales, diseñados para ofrecer comodidad y visión clara durante todo el día.", branchId: 'branch2', branchName: 'Sucursal Norte', ivaRate: 0.13 },
  { id: 'prod4', name: 'Solución Limpiadora Multiuso 360ml', price: 12500, stock: 100, category: 'Soluciones para Lentes de Contacto', sku: 'SLM-004', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'lens solution', lowStockThreshold: 30, costPrice: 5000, supplier: "CleanLens Group", description: "Solución multiuso para lentes de contacto blandos. Limpia, desinfecta, enjuaga y conserva.", branchId: 'branch1', branchName: 'Sucursal Central', expiryDate: '2025-12-31', ivaRate: 0.13 },
  { id: 'prod5', name: 'Paño de Microfibra Premium para Lentes', price: 3000, stock: 35, category: 'Accesorios para Gafas', sku: 'PMP-005', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'microfiber cloth', lowStockThreshold: 50, costPrice: 500, supplier: "MicroClean Tech", description: "Paño de microfibra de alta calidad para limpiar lentes sin rayarlos. Reutilizable y lavable.", branchId: 'branch2', branchName: 'Sucursal Norte', tag: 'Roja', ivaRate: 0.13 },
  { id: 'prod6', name: 'Gotas Lubricantes Oftálmicas', price: 15000, stock: 12, category: 'Gotas Oftálmicas / Lágrimas Artificiales', sku: 'GOT-LUB-01', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'eye drops', lowStockThreshold: 5, costPrice: 7000, supplier: "OptiPharma", description: "Alivio inmediato para ojos secos e irritados. Fórmula avanzada.", branchId: 'branch3', branchName: 'Sucursal Satélite', expiryDate: '2024-09-15', ivaRate: 0.13 },
];
...
const ProductDetailPage: NextPage = () => {
  ...
  useEffect(() => {
    if (productId) {
      setIsLoading(true);
      // TODO: Backend Integration - Fetch product data from Firestore using productId
      // SIMULATED: Find product in mock data
