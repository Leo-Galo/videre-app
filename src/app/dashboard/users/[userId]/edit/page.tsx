...
// This should be kept in sync or fetched from a central mock store if possible
const mockClinicUsers: ClinicUser[] = [
  { id: 'user1', name: 'Dr. Alan Grant', email: 'alan.grant@opticadmin.com', role: 'Admin', status: 'Active', createdAt: '2023-01-10T10:00:00Z', lastLogin: '2024-07-20T10:00:00Z' },
  { id: 'user2', name: 'Laura Opto', email: 'laura.opto@videre.com', role: 'Optómetra', status: 'Active', createdAt: '2023-02-15T10:00:00Z', lastLogin: '2024-07-21T09:00:00Z' },
  { id: 'user3', name: 'Carlos Ventas', email: 'carlos.ventas@videre.com', role: 'Asesor', status: 'Active', createdAt: '2023-03-20T10:00:00Z', lastLogin: '2024-07-21T14:00:00Z' },
  { id: 'user4', name: 'Sofía Recepción', email: 'sofia.recep@videre.com', role: 'Asesor', status: 'Inactive', createdAt: '2023-04-05T10:00:00Z' },
];
...
const EditUserPage: NextPage = () => {
  ...
  useEffect(() => {
    if (userId) {
      ...
      const foundUser = mockClinicUsers.find(u => u.id === userId);
      setTimeout(() => {
  ...
  const handleSuccess = (updatedFormData: EditUserFormValues) => {
    if (!user) return;

    const updatedUser: ClinicUser = {
      ...user, // Preserve original ID, status, createdAt etc.
      name: updatedFormData.name,
      // email: updatedFormData.email, // Email shouldn't be editable here
    ...
    toast({
      ...
      description: `El usuario "${updatedUser.name}" ha sido actualizado exitosamente (simulado).`,
    });
